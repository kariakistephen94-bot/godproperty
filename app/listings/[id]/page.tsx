                ...
                {listing.type === 'airbnb' ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex flex-col gap-3">
                      <a href="tel:+2348000000000" className="flex items-center justify-center w-full py-3.5 rounded-xl bg-red-600 text-white font-bold shadow-lg shadow-red-600/20 hover:bg-red-700 btn-press transition-all gap-2">
                        <Phone className="w-5 h-5" />
                        Call Us
                      </a>
                      <a href="https://wa.me/2348000000000" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-full py-3.5 rounded-xl bg-[#25D366] text-white font-bold shadow-lg shadow-[#25D366]/20 hover:bg-[#20bd5a] btn-press transition-all gap-2">
